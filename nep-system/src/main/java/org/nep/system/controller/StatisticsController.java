...
public class StatisticsController {
    ...
    public Result<Map<String, Object>> overview() {
        ...
        completedW.eq(SupervisionFeedback::getStatus, FeedbackStatusEnum.COMPLETED);
        ...
        pendingW.eq(SupervisionFeedback::getStatus, FeedbackStatusEnum.PENDING);
    ...
    public Result<Map<String, Object>> feedbackStatus() {
        ...
        assignedW.eq(SupervisionFeedback::getStatus, FeedbackStatusEnum.ASSIGNED);
    ...
    public Result<List<Map<String, Object>>> monthlyTrend() {
        ...
        int[] mockCounts = {45, 62, 58, 85, 120, 95};
        for (int i = 5; i >= 0; i--) {
            Map<String, Object> item = new LinkedHashMap<>();
