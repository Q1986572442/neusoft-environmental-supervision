...
async function handleLogin() {
  ...
  try {
    ...
    switch (role) {
      case 'NEPS': router.push('/ne/home'); break
      case 'NEPG': router.push('/nepg/home'); break
      case 'NEPM': router.push('/admin/dashboard'); break
      case 'NEPV': router.push('/nepv/dashboard'); break
      default: router.push('/ne/home')
    }
  } catch (e) {
    // 错误已在拦截器处理
  } finally {
